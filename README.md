...
This repo holds the foundation pieces: record shapes, the keys recipe, the registry and escrow programs, the host, the carrier, the index, the fee payer, the issuer flow, and names. Products are thin apps on top, in their own repos.
